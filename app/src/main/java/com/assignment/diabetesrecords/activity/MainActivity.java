...
public class MainActivity extends AppCompatActivity implements
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(SummaryFragment.newInstance(MainActivity.this), "Historique");
        //   EntriesFragment entriesFragment = EntriesFragment.newInstance(this);
        adapter.addFrag(EntriesOptionsFragment.newInstance(MainActivity.this), "Entrées");
        adapter.addFrag(new GraphFragment(), "Graphe");
        //   adapter.addFrag(MedicineFragment.newInstance(MainActivity.this), "Medicine");
        adapter.addFrag(MedicineLogFragment.newInstance(MainActivity.this), "Médicaments");
        adapter.addFrag(DoctorFragment.newInstance(MainActivity.this), "Médecins");
        adapter.addFrag(new FoodExerciseFragment(), "Nutrition & Sport");
